...
export function Button({ variant = 'outline', ...rest }: ButtonProps) {
	const classes = clsx(
		...
		{
			'border-none bg-gb-green-700 text-white hover:bg-gb-green-100 hover:text-gb-green-900 focus:ring-gb-green-700   disabled:bg-gb-gray-500 disabled:text-white':
				variant === 'solid',
