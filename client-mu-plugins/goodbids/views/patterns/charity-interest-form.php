...
<div class="wp-block-group charity-interest-form has-base-2-color has-contrast-background-color has-text-color has-background has-link-color"
	...
	<div class="wp-block-jetpack-contact-form is-style-default has-base-color has-text-color has-link-color" style="padding-top:16px;padding-right:16px;padding-bottom:16px;padding-left:16px">
		...
		<!-- wp:jetpack/field-text {"label":"Charity Legal Name","required":true,"requiredText":"(required)","placeholder":"E.g. My Charity, Inc.","borderRadius":30,"borderWidth":2,"lineHeight":1,"inputColor":"#FFFFFF","fieldBackgroundColor":"#0A3624","borderColor":"#D9FFD2","className":"placeholder:text-base focus:outline-contrast-4"} /-->

		<!-- wp:jetpack/field-text {"label":"Charity EIN","required":true,"requiredText":"(required)","placeholder":"XX-XXXXXXX","borderRadius":30,"borderWidth":2,"lineHeight":1,"inputColor":"#FFFFFF","fieldBackgroundColor":"#0A3624","borderColor":"#D9FFD2","className":"placeholder:text-base focus:outline-contrast-4"} /-->

		<!-- wp:jetpack/field-url {"label":"Charity Website","required":true,"requiredText":"(required)","placeholder":"https://","borderRadius":30,"borderWidth":2,"lineHeight":1,"inputColor":"#FFFFFF","fieldBackgroundColor":"#0A3624","borderColor":"#D9FFD2","className":"placeholder:text-base focus:outline-contrast-4"} /-->
