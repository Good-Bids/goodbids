...
<?php endif; ?>
	...
	<div class="gb-toggle">
		<label class="relative inline-flex items-center cursor-pointer">
			...
			<input type="checkbox" name="<?php echo esc_attr( $prefix ); ?>[<?php echo esc_attr( $key ); ?>]" id="<?php echo esc_attr( $field_id ); ?>" value="1" <?php checked( 1, intval( $value ) ); ?> class="sr-only peer">
