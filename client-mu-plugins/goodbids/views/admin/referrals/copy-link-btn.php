...
?>
<div class="goodbids-referrals-copy-link-btn">
	<div>
		<div class="relative tooltip">
			<span class="tooltiptext">
				<span class="text-xs absolute z-10 hidden text-center left-1/2 py-1 px-0 -translate-x-1/2 w-24 bottom-2 bg-contrast-3 text-contrast rounded after:content-[''] after:-ml-1 after:absolute after:top-full after:left-1/2 after:border-8 after:border-solid after:border-t-contrast-3 after:border-x-transparent after:border-b-transparent tooltip-visible:visible tooltip-visible:block tooltip-visible:opacity-100">
					<?php esc_html_e( 'Copied!', 'goodbids' ); ?>
				</span>
			</span>
			<label class="hidden">
				<?php esc_html_e( 'Your Custom Share Link', 'goodbids' ); ?>
				<input readonly type="text" value="<?php echo esc_url( $referrer->get_link() ); ?>">
			</label>
		</div>
