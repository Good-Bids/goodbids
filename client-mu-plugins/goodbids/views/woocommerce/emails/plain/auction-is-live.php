...
printf(
	...
	esc_html__( 'The %1$s auction you are watching is now open for bidding. Visit the auction to support %2$s mission and place a bid for your chance to win the %4$s!', 'goodbids' ),
	'{auction.title}',
	esc_html( $site_name ),
	'{auction.url}'
);
