...
<p class="text-xs">
	<?php
			printf(
				esc_html( 'These are the payment methods you\'ve saved on the %s Nonprofit site. Saved payment methods are not shared between Nonprofit sites.', 'woocommerce' ),
